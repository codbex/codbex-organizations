...
const validationModules = await Extensions.loadExtensionModules("codbex-organizations-Teams-JobPosition", ["validate"]);
...
class JobPositionService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-organizations/gen/codbex-organizations/api/Teams/JobPositionService.ts/" + entity.Id);
